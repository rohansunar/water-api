...
export class SalesAnalyticsResponseDto {
 ...
 @ApiProperty({
   ...
   example: [
     { productId: 'prod-1', productName: '20L Water Jar', sales: 5000, orders: 50 },
     { productId: 'prod-2', productName: '10L Water Jar', sales: 3000, orders: 60 },
   ],
 })
 topProducts: Array<{
   productId: string;
...
export class DailyReportDto {
 ...
 @ApiProperty({
   ...
   example: [
     { productId: 'prod-1', productName: '20L Water Jar', quantity: 25, revenue: 2500 },
     { productId: 'prod-2', productName: '10L Water Jar', quantity: 15, revenue: 1500 },
   ],
 })
 topProducts: Array<{
   productId: string;
