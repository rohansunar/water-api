...
export class DatabaseIndexStrategy {
   ...
   */
  private static async applyAddressIndexes(connection: Connection): Promise<void> {
   ...
   */
  private static async applyProductIndexes(connection: Connection): Promise<void> {
   ...
   */
  private static async applyOrderIndexes(connection: Connection): Promise<void> {
    ...
    await collection.createIndex({ vendorId: 1, createdAt: -1, totalAmount: 1 });
  }

  /**
   * Delivery task indexes with geospatial optimization
   */
  private static async applyDeliveryTaskIndexes(connection: Connection): Promise<void> {
   ...
   */
  private static async applyPaymentIndexes(connection: Connection): Promise<void> {
   ...
   */
  private static async applySubscriptionIndexes(connection: Connection): Promise<void> {
   ...
   */
  private static async applyWalletIndexes(connection: Connection): Promise<void> {
    // Wallet indexes
   ...
   */
  private static async applyVendorStoreIndexes(connection: Connection): Promise<void> {
  ...
  private static async applyVendorAreaIndexes(connection: Connection): Promise<void> {
  ...
  private static async applyOrderItemIndexes(connection: Connection): Promise<void> {
  ...
  private static async applyLedgerEntryIndexes(connection: Connection): Promise<void> {
  ...
  private static async applyPayoutIndexes(connection: Connection): Promise<void> {
  ...
  private static async applyComplaintIndexes(connection: Connection): Promise<void> {
